 ...
 */
class ConsultaGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Consulta entity")
        ...
        .repeat(2) {
            ...
            .pause(10)
            .repeat(5) {
                exec(http("Get created consulta")
                .get("${new_consulta_url}")
                .headers(headers_http_authenticated))
                .pause(10)
            }
            .exec(http("Delete created consulta")
            .delete("${new_consulta_url}")
            .headers(headers_http_authenticated))
            .pause(10)
        }
