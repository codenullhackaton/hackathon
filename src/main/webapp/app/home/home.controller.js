(function () {
    ...
    HomeController.$inject = ['$scope', 'Principal', 'LoginService', '$state','ConsultaCooperado'];

    function HomeController($scope, Principal, LoginService, $state, ConsultaCooperado) {
        var vm = this;
